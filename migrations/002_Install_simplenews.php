...
class Migration_Install_simplenews extends Migration {
	...
	public function up()
	{
		...
		'The 1 text area','selectmultiple 1, selectmultiple 2, selectmultiple 3' , 'checkbox 1, checkbox 2, checkbox 3', 'produto1.jpg') ");
		$this->db->query("INSERT INTO {$prefix}news VALUES(2, '2012-09-24 03:51:16','2012-11-22 17:56:16', 'The 2 title ever',2,0, 
		'The 2 text area', 'selectmultiple 1, selectmultiple 2, selectmultiple 3' , 'checkbox 1, checkbox 2, checkbox 3', 'produto2.jpg') ");		
		$this->db->query("INSERT INTO {$prefix}news VALUES(3, '2012-10-24 04:51:16','2012-11-22 17:56:16', 'The 3 title ever',3,1, 
		'The 3 text area', 'selectmultiple 1, selectmultiple 2, selectmultiple 3' , 'checkbox 1, checkbox 2, checkbox 3', 'produto3.jpg') ");
		$this->db->query("INSERT INTO {$prefix}news VALUES(4, '2012-11-01 05:51:16','2012-11-22 17:56:16', 'The 4 title ever',4,0, 
		'The 4 text area', 'selectmultiple 1, selectmultiple 2, selectmultiple 3' , 'checkbox 1, checkbox 2, checkbox 3', 'produto4.jpg') ");
		$this->db->query("INSERT INTO {$prefix}news VALUES(5, '2012-11-01 06:51:16','2012-11-22 17:56:16', 'The 5 title ever',5,1, 
		'The 5 text area', 'selectmultiple 1, selectmultiple 2, selectmultiple 3' , 'checkbox 1, checkbox 2, checkbox 3', 'produto5.jpg') ");
		...
		$this->dbforge->add_field('`cbx` TEXT NOT NULL');
		
		$this->dbforge->add_key('id', true);
		$this->dbforge->create_table('newsc');

		$this->db->query("INSERT INTO {$prefix}newsc VALUES(1 , 'newscheckboxes 1, newscheckboxes 1, newscheckboxes 1' , 'newscheckboxes 1, newscheckboxes 2, newscheckboxes 3')");
		$this->db->query("INSERT INTO {$prefix}newsc VALUES(2 , 'newscheckboxes 2, newscheckboxes 2, newscheckboxes 2' , 'newscheckboxes 1, newscheckboxes 2, newscheckboxes 3')");
