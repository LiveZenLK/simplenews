...
<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
    ...
    <?php if ($this->auth->has_permission('Simplenews.Content.Delete')) : ?>
            ...
            or <a class="btn btn-danger" id="delete-me" href="<?php echo site_url(SITE_AREA .'/content/simplenews/delete/'. $id);?>" onclick="return confirm('<?php echo lang('simplenews_delete_confirm'); ?>')" name="delete-me">
